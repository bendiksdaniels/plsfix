...
use crate::pen::Pen;
use crate::style::{Styles, BRONZE, CHARCOAL, EUR_K};
...
fn revenue_chart() -> Chart {
    ...
    chart
        ...
        .set_format(ChartSolidFill::new().set_color(BRONZE))
        .set_gap(BAR_GAP);
...
fn margin_chart() -> Chart {
    ...
    chart
        ...
        .set_format(ChartLine::new().set_color(CHARCOAL).set_width(LINE_WIDTH));
