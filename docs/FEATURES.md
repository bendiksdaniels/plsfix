...
| Link projects (folders) | - | A project name on every link, chosen in Excel above Linked objects and carried on the inbox item and the shape tag; the PowerPoint list and inbox filter and group by it, Push all / Update all honour the shown project; the relay never sees the name | shipped v2.8.6 | P1 (M3) |
