...
- Pure model modules (typed in/out, no I/O): `settings` (brand palette), `cycles`, `paste` (fill maths), `classify`, `audit`, `chartmath` (bridge, CAGR, tornado ranking), `model`, `reshape` (wide to long), `workbook`.
